...
namespace Unity.VisualScripting
{
	...
	{
		// Token: 0x06000637 RID: 1591 RVA: 0x00016734 File Offset: 0x00014934
		public InequalityHandler() : base("Inequality", "Not Equal", "!=", "op_Inequality")
		{
			...
			base.Handle<float, float>((float a, float b) => !Mathf.Approximately(a, b), false);
		...
		// Token: 0x06000638 RID: 1592 RVA: 0x00017789 File Offset: 0x00015989
		protected override object BothNullHandling()
		{
			return false;
		}

		// Token: 0x06000639 RID: 1593 RVA: 0x00017791 File Offset: 0x00015991
		protected override object SingleNullHandling()
		{
			return false;
		}

		// Token: 0x0600063A RID: 1594 RVA: 0x00017799 File Offset: 0x00015999
