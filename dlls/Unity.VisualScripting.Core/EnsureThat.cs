...
namespace Unity.VisualScripting
{
	...
	{
		// Token: 0x060001FE RID: 510 RVA: 0x00005080 File Offset: 0x00003280
		...
		// Token: 0x060001FF RID: 511 RVA: 0x0000509E File Offset: 0x0000329E
		...
		// Token: 0x06000200 RID: 512 RVA: 0x000050BC File Offset: 0x000032BC
		...
		// Token: 0x06000201 RID: 513 RVA: 0x000050EC File Offset: 0x000032EC
		...
		// Token: 0x06000202 RID: 514 RVA: 0x00005117 File Offset: 0x00003317
		...
		// Token: 0x06000203 RID: 515 RVA: 0x00005140 File Offset: 0x00003340
		...
		// Token: 0x06000204 RID: 516 RVA: 0x000051B0 File Offset: 0x000033B0
		public void HasItems<T>(IList<T> value)
		{
			this.HasItems<T>(value);
		}

		// Token: 0x06000205 RID: 517 RVA: 0x000051B9 File Offset: 0x000033B9
		...
		// Token: 0x06000206 RID: 518 RVA: 0x000051E4 File Offset: 0x000033E4
		public void SizeIs<T>(T[] value, int expected)
		{
			...
			{
				throw new ArgumentException(ExceptionMessages.Collections_SizeIs_Failed.Inject(new object[]
				{
					expected,
					value.Length
				}), this.paramName);
		...
		// Token: 0x06000207 RID: 519 RVA: 0x00005224 File Offset: 0x00003424
		...
		// Token: 0x06000208 RID: 520 RVA: 0x00005270 File Offset: 0x00003470
		...
		// Token: 0x06000209 RID: 521 RVA: 0x000052D0 File Offset: 0x000034D0
		...
		// Token: 0x0600020A RID: 522 RVA: 0x00005330 File Offset: 0x00003530
		...
		// Token: 0x0600020B RID: 523 RVA: 0x00005384 File Offset: 0x00003584
		...
		// Token: 0x0600020C RID: 524 RVA: 0x000053D6 File Offset: 0x000035D6
		public void SizeIs<T>(IList<T> value, int expected)
		{
			this.SizeIs<T>(value, expected);
		}

		// Token: 0x0600020D RID: 525 RVA: 0x000053E0 File Offset: 0x000035E0
		public void SizeIs<T>(IList<T> value, long expected)
		{
			this.SizeIs<T>(value, expected);
		}

		// Token: 0x0600020E RID: 526 RVA: 0x000053EC File Offset: 0x000035EC
		...
		// Token: 0x0600020F RID: 527 RVA: 0x00005440 File Offset: 0x00003640
		...
		// Token: 0x06000210 RID: 528 RVA: 0x00005494 File Offset: 0x00003694
		...
		// Token: 0x06000211 RID: 529 RVA: 0x000054EA File Offset: 0x000036EA
		public void Any<T>(IList<T> value, Func<T, bool> predicate)
		{
			this.Any<T>(value, predicate);
		}

		// Token: 0x06000212 RID: 530 RVA: 0x000054F4 File Offset: 0x000036F4
		...
		// Token: 0x06000213 RID: 531 RVA: 0x00005518 File Offset: 0x00003718
		...
		// Token: 0x06000214 RID: 532 RVA: 0x0000553C File Offset: 0x0000373C
		public void Is<T>(T param, T expected) where T : struct, IComparable<T>
		{
			...
			{
				throw new ArgumentException(ExceptionMessages.Comp_Is_Failed.Inject(new object[]
				{
					param,
					expected
				}), this.paramName);
		...
		// Token: 0x06000215 RID: 533 RVA: 0x00005590 File Offset: 0x00003790
		public void IsNot<T>(T param, T expected) where T : struct, IComparable<T>
		{
			...
			if (param.IsEq(expected))
			{
				throw new ArgumentException(ExceptionMessages.Comp_IsNot_Failed.Inject(new object[]
				{
					param,
					expected
				}), this.paramName);
		...
		// Token: 0x06000216 RID: 534 RVA: 0x000055E4 File Offset: 0x000037E4
		public void IsLt<T>(T param, T limit) where T : struct, IComparable<T>
		{
			...
			if (!param.IsLt(limit))
			{
				throw new ArgumentException(ExceptionMessages.Comp_IsNotLt.Inject(new object[]
				{
					param,
					limit
				}), this.paramName);
		...
		// Token: 0x06000217 RID: 535 RVA: 0x00005638 File Offset: 0x00003838
		public void IsLte<T>(T param, T limit) where T : struct, IComparable<T>
		{
			...
			if (param.IsGt(limit))
			{
				throw new ArgumentException(ExceptionMessages.Comp_IsNotLte.Inject(new object[]
				{
					param,
					limit
				}), this.paramName);
		...
		// Token: 0x06000218 RID: 536 RVA: 0x0000568C File Offset: 0x0000388C
		public void IsGt<T>(T param, T limit) where T : struct, IComparable<T>
		{
			...
			if (!param.IsGt(limit))
			{
				throw new ArgumentException(ExceptionMessages.Comp_IsNotGt.Inject(new object[]
				{
					param,
					limit
				}), this.paramName);
		...
		// Token: 0x06000219 RID: 537 RVA: 0x000056E0 File Offset: 0x000038E0
		public void IsGte<T>(T param, T limit) where T : struct, IComparable<T>
		{
			...
			if (param.IsLt(limit))
			{
				throw new ArgumentException(ExceptionMessages.Comp_IsNotGte.Inject(new object[]
				{
					param,
					limit
				}), this.paramName);
		...
		// Token: 0x0600021A RID: 538 RVA: 0x00005734 File Offset: 0x00003934
		public void IsInRange<T>(T param, T min, T max) where T : struct, IComparable<T>
		{
			...
			if (param.IsLt(min))
			{
				throw new ArgumentException(ExceptionMessages.Comp_IsNotInRange_ToLow.Inject(new object[]
				{
					param,
					min
				}), this.paramName);
			...
			if (param.IsGt(max))
			{
				throw new ArgumentException(ExceptionMessages.Comp_IsNotInRange_ToHigh.Inject(new object[]
				{
					param,
					max
				}), this.paramName);
		...
		// Token: 0x0600021B RID: 539 RVA: 0x000057C1 File Offset: 0x000039C1
		...
		// Token: 0x0600021C RID: 540 RVA: 0x000057EA File Offset: 0x000039EA
		...
		// Token: 0x0600021D RID: 541 RVA: 0x0000580E File Offset: 0x00003A0E
		...
		// Token: 0x0600021E RID: 542 RVA: 0x00005831 File Offset: 0x00003A31
		...
		// Token: 0x0600021F RID: 543 RVA: 0x00005854 File Offset: 0x00003A54
		...
		// Token: 0x06000220 RID: 544 RVA: 0x000058A1 File Offset: 0x00003AA1
		public void HasAttribute<TAttribute>(Type param) where TAttribute : Attribute
		{
			this.HasAttribute(param, typeof(TAttribute));
		}

		// Token: 0x06000221 RID: 545 RVA: 0x000058B4 File Offset: 0x00003AB4
		...
		// Token: 0x06000222 RID: 546 RVA: 0x00005911 File Offset: 0x00003B11
		...
		// Token: 0x06000223 RID: 547 RVA: 0x0000591C File Offset: 0x00003B1C
		...
		// Token: 0x06000224 RID: 548 RVA: 0x00005927 File Offset: 0x00003B27
		...
		// Token: 0x06000225 RID: 549 RVA: 0x00005951 File Offset: 0x00003B51
		...
		// Token: 0x06000226 RID: 550 RVA: 0x0000597B File Offset: 0x00003B7B
		...
		// Token: 0x06000227 RID: 551 RVA: 0x00005999 File Offset: 0x00003B99
		...
		// Token: 0x06000228 RID: 552 RVA: 0x000059C4 File Offset: 0x00003BC4
		public void HasLengthBetween(string value, int minLength, int maxLength)
		{
			...
			if (length < minLength)
			{
				throw new ArgumentException(ExceptionMessages.Strings_HasLengthBetween_Failed_ToShort.Inject(new object[]
				{
					minLength,
					maxLength,
					length
			...
			if (length > maxLength)
			{
				throw new ArgumentException(ExceptionMessages.Strings_HasLengthBetween_Failed_ToLong.Inject(new object[]
				{
					minLength,
					maxLength,
					length
		...
		// Token: 0x06000229 RID: 553 RVA: 0x00005A5D File Offset: 0x00003C5D
		public void Matches(string value, string match)
		{
			this.Matches(value, new Regex(match));
		}

		// Token: 0x0600022A RID: 554 RVA: 0x00005A6C File Offset: 0x00003C6C
		public void Matches(string value, Regex match)
		{
			...
			{
				throw new ArgumentException(ExceptionMessages.Strings_Matches_Failed.Inject(new object[]
				{
					value,
					match
				}), this.paramName);
		...
		// Token: 0x0600022B RID: 555 RVA: 0x00005AA4 File Offset: 0x00003CA4
		public void SizeIs(string value, int expected)
		{
			...
			if (value.Length != expected)
			{
				throw new ArgumentException(ExceptionMessages.Strings_SizeIs_Failed.Inject(new object[]
				{
					expected,
					value.Length
				}), this.paramName);
		...
		// Token: 0x0600022C RID: 556 RVA: 0x00005AFC File Offset: 0x00003CFC
		public void IsEqualTo(string value, string expected)
		{
			...
			{
				throw new ArgumentException(ExceptionMessages.Strings_IsEqualTo_Failed.Inject(new string[]
				{
					value,
					expected
				}), this.paramName);
		...
		// Token: 0x0600022D RID: 557 RVA: 0x00005B48 File Offset: 0x00003D48
		...
		// Token: 0x0600022E RID: 558 RVA: 0x00005B88 File Offset: 0x00003D88
		public void IsNotEqualTo(string value, string expected)
		{
			...
			if (this.StringEquals(value, expected, null))
			{
				throw new ArgumentException(ExceptionMessages.Strings_IsNotEqualTo_Failed.Inject(new string[]
				{
					value,
					expected
				}), this.paramName);
		...
		// Token: 0x0600022F RID: 559 RVA: 0x00005BD4 File Offset: 0x00003DD4
		...
		// Token: 0x06000230 RID: 560 RVA: 0x00005C12 File Offset: 0x00003E12
		public void IsGuid(string value)
		{
			...
			{
				throw new ArgumentException(ExceptionMessages.Strings_IsGuid_Failed.Inject(new string[]
				{
					value
				}), this.paramName);
			}
		...
		// Token: 0x06000231 RID: 561 RVA: 0x00005C44 File Offset: 0x00003E44
		...
		// Token: 0x06000232 RID: 562 RVA: 0x00005C68 File Offset: 0x00003E68
		...
		// Token: 0x06000233 RID: 563 RVA: 0x00005CDC File Offset: 0x00003EDC
		...
		// Token: 0x06000234 RID: 564 RVA: 0x00005D28 File Offset: 0x00003F28
		public void IsOfType<T>(object param)
		{
			this.IsOfType<object>(param, typeof(T));
		}

		// Token: 0x06000235 RID: 565 RVA: 0x00005D3B File Offset: 0x00003F3B
		public void IsOfType<T>(Type param)
		{
			this.IsOfType(param, typeof(T));
		}

		// Token: 0x06000236 RID: 566 RVA: 0x00005D50 File Offset: 0x00003F50
