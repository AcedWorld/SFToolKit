...
namespace System.Net.Sockets
{
	...
	public class TcpListener
	{
		...
		// Token: 0x06003F00 RID: 16128 RVA: 0x000D73D8 File Offset: 0x000D55D8
		...
		// Token: 0x06003F01 RID: 16129 RVA: 0x000D7424 File Offset: 0x000D5624
		...
		/// <exception cref="T:System.ArgumentOutOfRangeException">
		///   <paramref name="port" /> is not between <see cref="F:System.Net.IPEndPoint.MinPort" /> and <see cref="F:System.Net.IPEndPoint.MaxPort" />.</exception>
		// Token: 0x06003F02 RID: 16130 RVA: 0x000D748C File Offset: 0x000D568C
		...
		// Token: 0x06003F03 RID: 16131 RVA: 0x000D74DB File Offset: 0x000D56DB
		...
		// (get) Token: 0x06003F04 RID: 16132 RVA: 0x000D7513 File Offset: 0x000D5713
		...
		// (get) Token: 0x06003F05 RID: 16133 RVA: 0x000D751B File Offset: 0x000D571B
		...
		// (get) Token: 0x06003F06 RID: 16134 RVA: 0x000D7523 File Offset: 0x000D5723
		...
		// (get) Token: 0x06003F07 RID: 16135 RVA: 0x000D753F File Offset: 0x000D573F
		// (set) Token: 0x06003F08 RID: 16136 RVA: 0x000D754C File Offset: 0x000D574C
		...
		// Token: 0x06003F09 RID: 16137 RVA: 0x000D7579 File Offset: 0x000D5779
		...
		// Token: 0x06003F0A RID: 16138 RVA: 0x000D75B1 File Offset: 0x000D57B1
		public void Start()
		{
		...
		// Token: 0x06003F0B RID: 16139 RVA: 0x000D75C0 File Offset: 0x000D57C0
		...
		/// <exception cref="T:System.Net.Sockets.SocketException">Use the <see cref="P:System.Net.Sockets.SocketException.ErrorCode" /> property to obtain the specific error code. When you have obtained this code, you can refer to the Windows Sockets version 2 API error code documentation for a detailed description of the error.</exception>
		// Token: 0x06003F0C RID: 16140 RVA: 0x000D7658 File Offset: 0x000D5858
		public void Stop()
		{
			bool on = Logging.On;
			if (this.m_ServerSocket != null)
		...
		// Token: 0x06003F0D RID: 16141 RVA: 0x000D76BE File Offset: 0x000D58BE
		public bool Pending()
		{
			if (!this.m_Active)
			{
		...
		/// <exception cref="T:System.InvalidOperationException">The listener has not been started with a call to <see cref="M:System.Net.Sockets.TcpListener.Start" />.</exception>
		// Token: 0x06003F0E RID: 16142 RVA: 0x000D76E5 File Offset: 0x000D58E5
		...
		/// <exception cref="T:System.InvalidOperationException">The listener has not been started with a call to <see cref="M:System.Net.Sockets.TcpListener.Start" />.</exception>
		/// <exception cref="T:System.Net.Sockets.SocketException">Use the <see cref="P:System.Net.Sockets.SocketException.ErrorCode" /> property to obtain the specific error code. When you have obtained this code, you can refer to the Windows Sockets version 2 API error code documentation for a detailed description of the error.</exception>
		// Token: 0x06003F0F RID: 16143 RVA: 0x000D7716 File Offset: 0x000D5916
		...
		// Token: 0x06003F10 RID: 16144 RVA: 0x000D774C File Offset: 0x000D594C
		...
		// Token: 0x06003F11 RID: 16145 RVA: 0x000D7780 File Offset: 0x000D5980
		...
		/// <exception cref="T:System.Net.Sockets.SocketException">An error occurred while attempting to access the socket.</exception>
		/// <exception cref="T:System.ObjectDisposedException">The <see cref="T:System.Net.Sockets.Socket" /> has been closed.</exception>
		// Token: 0x06003F12 RID: 16146 RVA: 0x000D774C File Offset: 0x000D594C
		[HostProtection(SecurityAction.LinkDemand, ExternalThreading = true)]
		...
		// Token: 0x06003F13 RID: 16147 RVA: 0x000D77D8 File Offset: 0x000D59D8
		...
		/// <exception cref="T:System.InvalidOperationException">The listener has not been started with a call to <see cref="M:System.Net.Sockets.TcpListener.Start" />.</exception>
		// Token: 0x06003F14 RID: 16148 RVA: 0x000D7835 File Offset: 0x000D5A35
		[HostProtection(SecurityAction.LinkDemand, ExternalThreading = true)]
		...
		/// <exception cref="T:System.InvalidOperationException">The listener has not been started with a call to <see cref="M:System.Net.Sockets.TcpListener.Start" />.</exception>
		/// <exception cref="T:System.Net.Sockets.SocketException">Use the <see cref="P:System.Net.Sockets.SocketException.ErrorCode" /> property to obtain the specific error code. When you have obtained this code, you can refer to the Windows Sockets version 2 API error code documentation for a detailed description of the error.</exception>
		// Token: 0x06003F15 RID: 16149 RVA: 0x000D785A File Offset: 0x000D5A5A
		[HostProtection(SecurityAction.LinkDemand, ExternalThreading = true)]
