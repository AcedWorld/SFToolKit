...
namespace UnityEngine.Rendering.HighDefinition
{
	...
	{
		// Token: 0x06000A4E RID: 2638 RVA: 0x00058024 File Offset: 0x00056224
		internal static void ValidateMaterial(Material material)
		{
			...
			BaseLitAPI.SetupStencil(material, true, receivesSSR, material.GetMaterialId() == MaterialId.LitSSS, excludeFromTUAndAA);
			BaseLitAPI.SetupDisplacement(material, 1);
			if (material.HasProperty("_NormalMapSpace"))
			{
				...
				{
					CoreUtils.SetKeyword(material, "_NORMALMAP", material.GetTexture("_NormalMap") || material.GetTexture("_DetailMap"));
			...
			if (material.HasProperty("_MaterialID"))
			{
				...
				CoreUtils.SetKeyword(material, "_MATERIAL_FEATURE_CLEAR_COAT", (double)material.GetFloat("_CoatMask") > 0.0 || material.GetTexture("_CoatMaskMap"));
			...
			if (material.HasProperty("_RefractionModel"))
			{
				...
				CoreUtils.SetKeyword(material, "_TRANSMITTANCECOLORMAP", material.GetTexture("_TransmittanceColorMap") && flag2);
			}
		}
	}
}
