...
internal class UnitySourceGeneratedAssemblyMonoScriptTypes_v1
{
	...
	private static UnitySourceGeneratedAssemblyMonoScriptTypes_v1.MonoScriptData Get()
	{
		...
		result.FilePathsData = new byte[]
		{
			...
			111,
			98,
			"Not showing all elements because this array is too big (18843 elements)"
		};
		result.TypesData = new byte[]
		{
			...
			0,
			0,
			"Not showing all elements because this array is too big (20170 elements)"
		};
		result.TotalFiles = 167;
		result.TotalTypes = 394;
