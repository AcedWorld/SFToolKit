...
namespace Unity.VisualScripting
{
	...
	{
		// Token: 0x060000DD RID: 221 RVA: 0x00003B90 File Offset: 0x00001D90
		public Expose()
		{
		}

		// Token: 0x060000DE RID: 222 RVA: 0x00003BA6 File Offset: 0x00001DA6
		...
		// (get) Token: 0x060000DF RID: 223 RVA: 0x00003BC3 File Offset: 0x00001DC3
		// (set) Token: 0x060000E0 RID: 224 RVA: 0x00003BCB File Offset: 0x00001DCB
		[Serialize]
		[Inspectable]
		[TypeFilter(new Type[]
		{
		...
		// (get) Token: 0x060000E1 RID: 225 RVA: 0x00003BD4 File Offset: 0x00001DD4
		// (set) Token: 0x060000E2 RID: 226 RVA: 0x00003BDC File Offset: 0x00001DDC
		[Serialize]
		[Inspectable]
		...
		// (get) Token: 0x060000E3 RID: 227 RVA: 0x00003BE5 File Offset: 0x00001DE5
		// (set) Token: 0x060000E4 RID: 228 RVA: 0x00003BED File Offset: 0x00001DED
		[Serialize]
		[Inspectable]
		...
		// (get) Token: 0x060000E5 RID: 229 RVA: 0x00003BF6 File Offset: 0x00001DF6
		// (set) Token: 0x060000E6 RID: 230 RVA: 0x00003BFE File Offset: 0x00001DFE
		[DoNotSerialize]
		[PortLabelHidden]
		[NullMeansSelf]
		...
		// (get) Token: 0x060000E7 RID: 231 RVA: 0x00003C07 File Offset: 0x00001E07
		// (set) Token: 0x060000E8 RID: 232 RVA: 0x00003C0F File Offset: 0x00001E0F
		[DoNotSerialize]
		public Dictionary<ValueOutput, Member> members { get; private set; }

		// Token: 0x17000053 RID: 83
		// (get) Token: 0x060000E9 RID: 233 RVA: 0x00003C18 File Offset: 0x00001E18
		...
		// Token: 0x060000EA RID: 234 RVA: 0x00003C26 File Offset: 0x00001E26
		...
		// Token: 0x060000EB RID: 235 RVA: 0x00003C38 File Offset: 0x00001E38
		protected override void Definition()
		{
			...
			select m.ToManipulator(this.type)).DistinctBy((Member m) => m.name).Where(new Func<Member, bool>(this.Include)).OrderBy(delegate(Member m)
			{
				...
				return 0;
			}).ThenBy((Member m) => m.order).GetEnumerator())
			{
		...
		// Token: 0x060000EC RID: 236 RVA: 0x00003E50 File Offset: 0x00002050
		...
		// Token: 0x060000ED RID: 237 RVA: 0x00003ED4 File Offset: 0x000020D4
		private object GetValue(Flow flow, Member member)
		{
			object target = member.requiresTarget ? flow.GetValue(this.target, member.targetType) : null;
