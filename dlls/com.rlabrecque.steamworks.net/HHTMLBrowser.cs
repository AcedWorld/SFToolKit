...
namespace Steamworks
{
	...
	{
		// Token: 0x06000998 RID: 2456 RVA: 0x0000EB8B File Offset: 0x0000CD8B
		public HHTMLBrowser(uint value)
		{
			this.m_HHTMLBrowser = value;
		}

		// Token: 0x06000999 RID: 2457 RVA: 0x0000EB94 File Offset: 0x0000CD94
		public override string ToString()
		{
			return this.m_HHTMLBrowser.ToString();
		}

		// Token: 0x0600099A RID: 2458 RVA: 0x0000EBA1 File Offset: 0x0000CDA1
		public override bool Equals(object other)
		{
			return other is HHTMLBrowser && this == (HHTMLBrowser)other;
		}

		// Token: 0x0600099B RID: 2459 RVA: 0x0000EBBE File Offset: 0x0000CDBE
		public override int GetHashCode()
		{
			return this.m_HHTMLBrowser.GetHashCode();
		}

		// Token: 0x0600099C RID: 2460 RVA: 0x0000EBCB File Offset: 0x0000CDCB
		public static bool operator ==(HHTMLBrowser x, HHTMLBrowser y)
		{
			return x.m_HHTMLBrowser == y.m_HHTMLBrowser;
		}

		// Token: 0x0600099D RID: 2461 RVA: 0x0000EBDB File Offset: 0x0000CDDB
		public static bool operator !=(HHTMLBrowser x, HHTMLBrowser y)
		{
			return !(x == y);
		}

		// Token: 0x0600099E RID: 2462 RVA: 0x0000EBE7 File Offset: 0x0000CDE7
		public static explicit operator HHTMLBrowser(uint value)
		{
			return new HHTMLBrowser(value);
		}

		// Token: 0x0600099F RID: 2463 RVA: 0x0000EBEF File Offset: 0x0000CDEF
		public static explicit operator uint(HHTMLBrowser that)
		{
			return that.m_HHTMLBrowser;
		}

		// Token: 0x060009A0 RID: 2464 RVA: 0x0000EBF7 File Offset: 0x0000CDF7
		public bool Equals(HHTMLBrowser other)
		{
			return this.m_HHTMLBrowser == other.m_HHTMLBrowser;
		}

		// Token: 0x060009A1 RID: 2465 RVA: 0x0000EC07 File Offset: 0x0000CE07
