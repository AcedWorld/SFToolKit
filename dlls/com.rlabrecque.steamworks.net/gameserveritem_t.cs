...
namespace Steamworks
{
	...
	public class gameserveritem_t
	{
		...
		// Token: 0x06000922 RID: 2338 RVA: 0x0000E17A File Offset: 0x0000C37A
		public void SetServerName(string name)
		{
			this.m_szServerName = Encoding.UTF8.GetBytes(name + "\0");
		}

		// Token: 0x06000923 RID: 2339 RVA: 0x0000E197 File Offset: 0x0000C397
		public string GetGameTags()
		{
			return Encoding.UTF8.GetString(this.m_szGameTags, 0, Array.IndexOf<byte>(this.m_szGameTags, 0));
		}

		// Token: 0x06000924 RID: 2340 RVA: 0x0000E1B6 File Offset: 0x0000C3B6
