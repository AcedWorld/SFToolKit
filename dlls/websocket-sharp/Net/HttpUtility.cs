...
namespace WebSocketSharp.Net
{
	...
	{
		// Token: 0x060002F0 RID: 752 RVA: 0x000125E4 File Offset: 0x000107E4
		private static Dictionary<string, char> getEntities()
		{
			...
			lock (sync)
			{
				bool flag2 = HttpUtility._entities == null;
				if (flag2)
				{
		...
		// Token: 0x060002F1 RID: 753 RVA: 0x0001263C File Offset: 0x0001083C
		private static int getNumber(char c)
		{
			return (c >= '0' && c <= '9') ? ((int)(c - '0')) : ((c >= 'A' && c <= 'F') ? ((int)(c - 'A' + '\n')) : ((c >= 'a' && c <= 'f') ? ((int)(c - 'a' + '\n')) : -1));
		}

		// Token: 0x060002F2 RID: 754 RVA: 0x00012688 File Offset: 0x00010888
		...
		// Token: 0x060002F3 RID: 755 RVA: 0x000126DC File Offset: 0x000108DC
		...
		// Token: 0x060002F4 RID: 756 RVA: 0x00012734 File Offset: 0x00010934
		...
		// Token: 0x060002F5 RID: 757 RVA: 0x000129F0 File Offset: 0x00010BF0
		...
		// Token: 0x060002F6 RID: 758 RVA: 0x00012A8C File Offset: 0x00010C8C
		...
		// Token: 0x060002F7 RID: 759 RVA: 0x00013F44 File Offset: 0x00012144
		private static bool isAlphabet(char c)
		{
			return (c >= 'A' && c <= 'Z') || (c >= 'a' && c <= 'z');
		}

		// Token: 0x060002F8 RID: 760 RVA: 0x00013F74 File Offset: 0x00012174
		private static bool isNumeric(char c)
		{
			return c >= '0' && c <= '9';
		}

		// Token: 0x060002F9 RID: 761 RVA: 0x00013F98 File Offset: 0x00012198
		private static bool isUnreserved(char c)
		{
			return c == '*' || c == '-' || c == '.' || c == '_';
		}

		// Token: 0x060002FA RID: 762 RVA: 0x00013FC4 File Offset: 0x000121C4
		private static bool isUnreservedInRfc2396(char c)
		{
			return c == '!' || c == '\'' || c == '(' || c == ')' || c == '*' || c == '-' || c == '.' || c == '_' || c == '~';
		}

		// Token: 0x060002FB RID: 763 RVA: 0x00014008 File Offset: 0x00012208
		private static bool isUnreservedInRfc3986(char c)
		{
			return c == '-' || c == '.' || c == '_' || c == '~';
		}

		// Token: 0x060002FC RID: 764 RVA: 0x00014034 File Offset: 0x00012234
		...
		// Token: 0x060002FD RID: 765 RVA: 0x00014100 File Offset: 0x00012300
		...
		// Token: 0x060002FF RID: 767 RVA: 0x0001421C File Offset: 0x0001241C
		...
		// Token: 0x06000300 RID: 768 RVA: 0x000143B4 File Offset: 0x000125B4
		...
		// Token: 0x06000301 RID: 769 RVA: 0x00014548 File Offset: 0x00012748
		...
		// Token: 0x06000302 RID: 770 RVA: 0x000145FC File Offset: 0x000127FC
		...
		// Token: 0x06000303 RID: 771 RVA: 0x00014638 File Offset: 0x00012838
		...
		// Token: 0x06000304 RID: 772 RVA: 0x00014670 File Offset: 0x00012870
		...
		// Token: 0x06000305 RID: 773 RVA: 0x000146C4 File Offset: 0x000128C4
		...
		// Token: 0x06000306 RID: 774 RVA: 0x000146FC File Offset: 0x000128FC
		...
		// Token: 0x06000307 RID: 775 RVA: 0x0001474C File Offset: 0x0001294C
		...
		// Token: 0x06000308 RID: 776 RVA: 0x00014784 File Offset: 0x00012984
		...
		// Token: 0x06000309 RID: 777 RVA: 0x000147D8 File Offset: 0x000129D8
		public static string UrlDecode(string s)
		{
			return HttpUtility.UrlDecode(s, Encoding.UTF8);
		}

		// Token: 0x0600030A RID: 778 RVA: 0x000147F8 File Offset: 0x000129F8
		...
		// Token: 0x0600030B RID: 779 RVA: 0x00014844 File Offset: 0x00012A44
		...
		// Token: 0x0600030C RID: 780 RVA: 0x000148A0 File Offset: 0x00012AA0
		...
		// Token: 0x0600030D RID: 781 RVA: 0x00014964 File Offset: 0x00012B64
		...
		// Token: 0x0600030E RID: 782 RVA: 0x0001499C File Offset: 0x00012B9C
		...
		// Token: 0x0600030F RID: 783 RVA: 0x000149F0 File Offset: 0x00012BF0
		...
		// Token: 0x06000310 RID: 784 RVA: 0x00014AA4 File Offset: 0x00012CA4
		...
		// Token: 0x06000311 RID: 785 RVA: 0x00014AEC File Offset: 0x00012CEC
		public static string UrlEncode(string s)
		{
			return HttpUtility.UrlEncode(s, Encoding.UTF8);
		}

		// Token: 0x06000312 RID: 786 RVA: 0x00014B0C File Offset: 0x00012D0C
		...
		// Token: 0x06000313 RID: 787 RVA: 0x00014B88 File Offset: 0x00012D88
		...
		// Token: 0x06000314 RID: 788 RVA: 0x00014C48 File Offset: 0x00012E48
		...
		// Token: 0x06000315 RID: 789 RVA: 0x00014C80 File Offset: 0x00012E80
		public static byte[] UrlEncodeToBytes(string s)
		{
			return HttpUtility.UrlEncodeToBytes(s, Encoding.UTF8);
		}

		// Token: 0x06000316 RID: 790 RVA: 0x00014CA0 File Offset: 0x00012EA0
		...
		// Token: 0x06000317 RID: 791 RVA: 0x00014CF8 File Offset: 0x00012EF8
