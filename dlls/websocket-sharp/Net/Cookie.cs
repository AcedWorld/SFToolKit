...
namespace WebSocketSharp.Net
{
	...
	{
		// Token: 0x060001AD RID: 429 RVA: 0x0000BEF6 File Offset: 0x0000A0F6
		internal Cookie()
		{
			this.init(string.Empty, string.Empty, string.Empty, string.Empty);
		}

		// Token: 0x060001AE RID: 430 RVA: 0x0000BF1B File Offset: 0x0000A11B
		public Cookie(string name, string value) : this(name, value, string.Empty, string.Empty)
		{
		}

		// Token: 0x060001AF RID: 431 RVA: 0x0000BF31 File Offset: 0x0000A131
		public Cookie(string name, string value, string path) : this(name, value, path, string.Empty)
		{
		}

		// Token: 0x060001B0 RID: 432 RVA: 0x0000BF44 File Offset: 0x0000A144
		...
		// (get) Token: 0x060001B1 RID: 433 RVA: 0x0000C038 File Offset: 0x0000A238
		...
		// (get) Token: 0x060001B2 RID: 434 RVA: 0x0000C070 File Offset: 0x0000A270
		// (set) Token: 0x060001B3 RID: 435 RVA: 0x0000C0E0 File Offset: 0x0000A2E0
		internal int MaxAge
		{
			get
			{
		...
		// (get) Token: 0x060001B4 RID: 436 RVA: 0x0000C110 File Offset: 0x0000A310
		internal int[] Ports
		{
			get
			{
		...
		// (get) Token: 0x060001B5 RID: 437 RVA: 0x0000C134 File Offset: 0x0000A334
		// (set) Token: 0x060001B6 RID: 438 RVA: 0x0000C14C File Offset: 0x0000A34C
		...
		// (get) Token: 0x060001B7 RID: 439 RVA: 0x0000C158 File Offset: 0x0000A358
		// (set) Token: 0x060001B8 RID: 440 RVA: 0x0000C170 File Offset: 0x0000A370
		...
		// (get) Token: 0x060001B9 RID: 441 RVA: 0x0000C17C File Offset: 0x0000A37C
		// (set) Token: 0x060001BA RID: 442 RVA: 0x0000C194 File Offset: 0x0000A394
		...
		// (get) Token: 0x060001BB RID: 443 RVA: 0x0000C1A0 File Offset: 0x0000A3A0
		// (set) Token: 0x060001BC RID: 444 RVA: 0x0000C1B8 File Offset: 0x0000A3B8
		public bool Discard
		{
			get
			{
		...
		// (get) Token: 0x060001BD RID: 445 RVA: 0x0000C1C4 File Offset: 0x0000A3C4
		// (set) Token: 0x060001BE RID: 446 RVA: 0x0000C1DC File Offset: 0x0000A3DC
		...
		// (get) Token: 0x060001BF RID: 447 RVA: 0x0000C1F0 File Offset: 0x0000A3F0
		// (set) Token: 0x060001C0 RID: 448 RVA: 0x0000C227 File Offset: 0x0000A427
		public bool Expired
		{
			get
			{
		...
		// (get) Token: 0x060001C1 RID: 449 RVA: 0x0000C240 File Offset: 0x0000A440
		// (set) Token: 0x060001C2 RID: 450 RVA: 0x0000C258 File Offset: 0x0000A458
		...
		// (get) Token: 0x060001C3 RID: 451 RVA: 0x0000C264 File Offset: 0x0000A464
		// (set) Token: 0x060001C4 RID: 452 RVA: 0x0000C27C File Offset: 0x0000A47C
		...
		// (get) Token: 0x060001C5 RID: 453 RVA: 0x0000C288 File Offset: 0x0000A488
		// (set) Token: 0x060001C6 RID: 454 RVA: 0x0000C2A0 File Offset: 0x0000A4A0
		public string Name
		{
			get
			{
		...
		// (get) Token: 0x060001C7 RID: 455 RVA: 0x0000C32C File Offset: 0x0000A52C
		// (set) Token: 0x060001C8 RID: 456 RVA: 0x0000C344 File Offset: 0x0000A544
		public string Path
		{
			get
			{
		...
		// (get) Token: 0x060001C9 RID: 457 RVA: 0x0000C358 File Offset: 0x0000A558
		// (set) Token: 0x060001CA RID: 458 RVA: 0x0000C370 File Offset: 0x0000A570
		public string Port
		{
			get
			{
		...
		// (get) Token: 0x060001CB RID: 459 RVA: 0x0000C3A0 File Offset: 0x0000A5A0
		// (set) Token: 0x060001CC RID: 460 RVA: 0x0000C3B8 File Offset: 0x0000A5B8
		public bool Secure
		{
			get
			{
		...
		// (get) Token: 0x060001CD RID: 461 RVA: 0x0000C3C4 File Offset: 0x0000A5C4
		...
		// (get) Token: 0x060001CE RID: 462 RVA: 0x0000C3DC File Offset: 0x0000A5DC
		// (set) Token: 0x060001CF RID: 463 RVA: 0x0000C3F4 File Offset: 0x0000A5F4
		public string Value
		{
			get
			{
		...
		// (get) Token: 0x060001D0 RID: 464 RVA: 0x0000C44C File Offset: 0x0000A64C
		// (set) Token: 0x060001D1 RID: 465 RVA: 0x0000C464 File Offset: 0x0000A664
		public int Version
		{
			get
			{
		...
		// Token: 0x060001D2 RID: 466 RVA: 0x0000C48C File Offset: 0x0000A68C
		private static int hash(int i, int j, int k, int l, int m)
		{
			return i ^ (j << 13 | j >> 19) ^ (k << 26 | k >> 6) ^ (l << 7 | l >> 25) ^ (m << 20 | m >> 12);
		}

		// Token: 0x060001D3 RID: 467 RVA: 0x0000C4C7 File Offset: 0x0000A6C7
		...
		// Token: 0x060001D4 RID: 468 RVA: 0x0000C500 File Offset: 0x0000A700
		...
		// Token: 0x060001D5 RID: 469 RVA: 0x0000C620 File Offset: 0x0000A820
		...
		// Token: 0x060001D6 RID: 470 RVA: 0x0000C7B8 File Offset: 0x0000A9B8
		...
		// Token: 0x060001D7 RID: 471 RVA: 0x0000C858 File Offset: 0x0000AA58
		...
		// Token: 0x060001D8 RID: 472 RVA: 0x0000C8BC File Offset: 0x0000AABC
		...
		// Token: 0x060001D9 RID: 473 RVA: 0x0000C910 File Offset: 0x0000AB10
		...
		// Token: 0x060001DA RID: 474 RVA: 0x0000CA80 File Offset: 0x0000AC80
		...
		// Token: 0x060001DB RID: 475 RVA: 0x0000CABC File Offset: 0x0000ACBC
		...
		// Token: 0x060001DC RID: 476 RVA: 0x0000CAF8 File Offset: 0x0000ACF8
		...
		// Token: 0x060001DD RID: 477 RVA: 0x0000CB88 File Offset: 0x0000AD88
		...
		// Token: 0x060001DE RID: 478 RVA: 0x0000CBDC File Offset: 0x0000ADDC
