...
namespace Cinemachine
{
	...
	public class CinemachineBasicMultiChannelPerlin : CinemachineComponentBase
	{
		...
		// (get) Token: 0x0600018C RID: 396 RVA: 0x0000C1EA File Offset: 0x0000A3EA
		...
		// (get) Token: 0x0600018D RID: 397 RVA: 0x0000C202 File Offset: 0x0000A402
		...
		// Token: 0x0600018E RID: 398 RVA: 0x0000C208 File Offset: 0x0000A408
		...
		// Token: 0x0600018F RID: 399 RVA: 0x0000C369 File Offset: 0x0000A569
		public void ReSeed()
		{
			this.mNoiseOffsets = new Vector3(Random.Range(-1000f, 1000f), Random.Range(-1000f, 1000f), Random.Range(-1000f, 1000f));
		}

		// Token: 0x06000190 RID: 400 RVA: 0x0000C3A3 File Offset: 0x0000A5A3
