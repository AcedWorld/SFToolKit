...
namespace Cinemachine
{
	...
	public abstract class CinemachineExtension : MonoBehaviour
	{
		...
		// (get) Token: 0x06000292 RID: 658 RVA: 0x000123AE File Offset: 0x000105AE
		...
		// Token: 0x06000293 RID: 659 RVA: 0x000123D0 File Offset: 0x000105D0
		protected virtual void Awake()
		{
			this.ConnectToVcam(true);
		}

		// Token: 0x06000294 RID: 660 RVA: 0x000123D9 File Offset: 0x000105D9
		protected virtual void OnEnable()
		{
		}

		// Token: 0x06000295 RID: 661 RVA: 0x000123DB File Offset: 0x000105DB
		protected virtual void OnDestroy()
		{
			this.ConnectToVcam(false);
		}

		// Token: 0x06000296 RID: 662 RVA: 0x000123E4 File Offset: 0x000105E4
		internal void EnsureStarted()
		{
			this.ConnectToVcam(true);
		}

		// Token: 0x06000297 RID: 663 RVA: 0x000123F0 File Offset: 0x000105F0
		...
		// Token: 0x06000298 RID: 664 RVA: 0x0001244A File Offset: 0x0001064A
		...
		// Token: 0x06000299 RID: 665 RVA: 0x0001244C File Offset: 0x0001064C
		...
		// Token: 0x0600029B RID: 667 RVA: 0x00012459 File Offset: 0x00010659
		public virtual void OnTargetObjectWarped(Transform target, Vector3 positionDelta)
		{
		}

		// Token: 0x0600029C RID: 668 RVA: 0x0001245B File Offset: 0x0001065B
		public virtual void ForceCameraPosition(Vector3 pos, Quaternion rot)
		{
		}

		// Token: 0x0600029D RID: 669 RVA: 0x0001245D File Offset: 0x0001065D
		public virtual bool OnTransitionFromCamera(ICinemachineCamera fromCam, Vector3 worldUp, float deltaTime)
		{
			return false;
		}

		// Token: 0x0600029E RID: 670 RVA: 0x00012460 File Offset: 0x00010660
		...
		// (get) Token: 0x0600029F RID: 671 RVA: 0x00012467 File Offset: 0x00010667
		...
		// Token: 0x060002A0 RID: 672 RVA: 0x0001246C File Offset: 0x0001066C
		...
		// Token: 0x060002A1 RID: 673 RVA: 0x000124C4 File Offset: 0x000106C4
